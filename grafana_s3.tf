data template_file "grafana" {
  ...
  vars = {
    ...
    client_id      = data.terraform_remote_state.dataworks_cognito.outputs.grafana_client.id
    client_secret  = data.terraform_remote_state.dataworks_cognito.outputs.grafana_client.client_secret
