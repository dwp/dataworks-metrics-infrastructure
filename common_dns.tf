...
# This resources cannot recreated after the stack was completely rebuilt. Hence removed from management-dev for now.
resource "aws_route53_zone" "monitoring" {
  count = local.environment == "management-dev" ? 0 : 1
