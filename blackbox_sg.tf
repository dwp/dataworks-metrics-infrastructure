resource "aws_security_group_rule" "allow_blackbox_egress_https" {
  ...
  security_group_id = data.terraform_remote_state.aws_sdx.outputs.vpce_security_groups.blackbox_vpce_security_group.id
...
resource "aws_security_group_rule" "allow_prometheus_egress_blackbox" {
  ...
  source_security_group_id = data.terraform_remote_state.aws_sdx.outputs.vpce_security_groups.blackbox_vpce_security_group.id
}
