...
resource "aws_s3_object" "metrics_logrotate_script" {
  ...
  kms_key_id = local.is_management_env ? data.terraform_remote_state.management.outputs.config_bucket_cmk : data.terraform_remote_state.common.outputs.config_bucket_cmk
