...
resource "aws_ecs_cluster" "metrics_ecs_cluster" {
  ...
  default_capacity_provider_strategy {
    capacity_provider = aws_ecs_capacity_provider.metrics_ecs_cluster.name
  }
...
resource "aws_ecs_capacity_provider" "metrics_ecs_cluster" {
  name = local.metrics_ecs_friendly_name
...
resource "aws_launch_template" "metrics_ecs_cluster" {
  name          = local.metrics_ecs_friendly_name
